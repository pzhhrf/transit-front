<template>
    <div class="index">
        ...
        <div class="in_01">
            ...
            <div class="in01_02">
                <div class="a01 li">
                    <img src="../assets/i01.png" /> 提取链接
                </div>
                <div class="l01 li"><img src="../assets/i04.png" /></div>
                <div class="a02 li">
                    <img src="../assets/i02.png" /> 添加中转
                </div>
                <div class="l01 li"><img src="../assets/i04.png" /></div>
                <div class="a03 li">
                    <img src="../assets/i03.png" /> 取回本地
                </div>
            </div>
            <div class="in01_03">
                <textarea
        ...
        <div class="in_02">
            <div class="li01">
                <div class="line">
                    <div class="img"><img src="../assets/i05.png" /></div>
                    <div class="title">Rapidgator</div>
                    <div class="des">https://rapidgator.net/file/xxxx</div>
                </div>
                <div class="line">
                    <div class="img"><img src="../assets/i05.png" /></div>
                    <div class="title">Rapidgator</div>
